...
<body>
	...
	<h1 style="color: red; text-align: center;">Ajouter une commande</h1>
	<div class="container">



		<form:form cssClass="form-horizontal" method="get" action="submitAddCom" >
			...
			<div class="form-group">
				<label for="idID" class="col-sm-2 control-label">Adresse:</label>
				<div class="col-sm-10">
